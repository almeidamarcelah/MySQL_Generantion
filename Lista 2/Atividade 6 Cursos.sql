...
insert into tb_categorias (formacao,descricao,codigo) value ("Programação","aprender a programar em back-end","8855");
insert into tb_categorias (formacao,descricao,codigo) value ("Front-end","aprender a programar em front-end (O guache na tela)","1022");
insert into tb_categorias (formacao,descricao,codigo) value ("Data Science","utilizar banco de dados","2236");
insert into tb_categorias (formacao,descricao,codigo) value ("Mobile","aprender a programação para android","4469");
insert into tb_categorias (formacao,descricao,codigo) value ("Inovação e Gestão","gestão Scrum e desenvolvimento interpessoal","2237");
...
select tb_categorias.formacao, tb_categorias.descricao, tb_categorias.codigo, 
tb_cursos.curso,tb_cursos.duracao,tb_cursos.preco,tb_cursos.quantidadeAulas,tb_cursos.categoria_id
from tb_categorias inner join tb_cursos on tb_categorias.id = tb_cursos.categoria_id;
