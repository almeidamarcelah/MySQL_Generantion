...
insert into tb_categoria (codigo,produto,tipo) value (100,"Morango","Fruta");
insert into tb_categoria (codigo,produto,tipo) value (110,"Milho","Legumes");
insert into tb_categoria (codigo,produto,tipo) value (120,"Alface","vergura");
insert into tb_categoria (codigo,produto,tipo) value (130,"Brócolis, Couve-flor, Milho, Ervilha","Legumes");
insert into tb_categoria (codigo,produto,tipo) value (140,"Leite e Queijo","Laticinios");
...
insert into tb_produtos (preco,quantidade,congelado,descricao,origem,categoria_id) value (20.00,false,"Pé de Alface freco","São Paulo",3);
...
select tb_categora.codigo, tb_categoria.produto, tb_categoria.tipo, 
