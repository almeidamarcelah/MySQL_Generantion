...
insert into tb_categoria (decoracao,ferramentas,materiais) value ("Quarto","Espátula Celuloide","Papel de Parede e adesivos decorativos");
insert into tb_categoria (decoracao,ferramentas,materiais) value ("Banheiro","parafusadeira, parafusos","Barra de apoio de segurança,box");
insert into tb_categoria (decoracao,ferramentas,materiais) value ("Cozinha","massa,cimento","azuleijos");
insert into tb_categoria (decoracao,ferramentas,materiais) value ("Sala","massa","piso de madeira e azulejos");
insert into tb_categoria (decoracao,ferramentas,materiais) value ("Jardim","materiais de jardinagem","Aplicação de grama, banco decorativos");
...
select*from tb_produtos where decoracao like "%c%";

select tb_categora.decoracao, tb_categoria.ferramentas, tb_categoria.materiais, 
